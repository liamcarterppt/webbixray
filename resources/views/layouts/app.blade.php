                                                        ...
                                                        <div class="row justify-content-center">
                                                            <div class="col-lg-12 px-0">
                                                                <div class="feature-logos mt-5">
                                                                    <div class="slide">
                                                                        <img src="../assets/images/landing/web/1.png" alt="image">
                                                                        <h5 class="mt-3 text-white">Bootstrap5</h5>
                                                                    </div>
                                                                    <div class="slide">
                                                                        <img src="../assets/images/landing/web/2.png" alt="image">
                                                                        <h5 class="mt-3 text-white">HTML5</h5>
                                                                    </div>
                                                                    <div class="slide">
                                                                        <img src="../assets/images/landing/web/3.png" alt="image">
                                                                        <h5 class="mt-3 text-white">JQuery</h5>
                                                                    </div>
                                                                    <div class="slide">
                                                                        <img src="../assets/images/landing/web/4.png" alt="image">
                                                                        <h5 class="mt-3 text-white">Sass</h5>
                                                                    </div>
                                                                    <div class="slide">
                                                                        <img src="../assets/images/landing/web/5.png" alt="image">
                                                                        <h5 class="mt-3 text-white">Gulp</h5>
                                                                    </div>
                                                                    <div class="slide">
                                                                        <img src="../assets/images/landing/web/6.png" alt="image">
                                            ...
                                            <section class="sptb demo-screen-demo" id="faqs1">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-12 col-lg-6 reveal revealright">
                                                        <img src="../assets/images/landing/2.png"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </section>
                                                ...
                                                <div class="card bg-transparent reveal">
                                                    <div class="card-body px-1">
                                                        <div class="d-flex overflow-visible">
                                                            <a href="blog-details.html"
                                                                class="card-aside-column br-5 cover-image"
                                                                data-bs-image-src="../assets/images/media/28.jpg"
                                                                style="background: url(&quot;../assets/images/media/28.jpg&quot;) center center;"></a>
                                                            <div class="ps-3 flex-column">
                                                                <span
                                            ...
                                            <div class="text-center">
                                                <a href="blog.html" target="_blank"
                                                    class="btn btn-outline-primary pt-2 pb-2"><i
                                                        class="fe fe-arrow-right me-2 d-inline-flex"></i>Discover More
                                                </a>
                                            </div>
                                        </div>
                                    </div>
